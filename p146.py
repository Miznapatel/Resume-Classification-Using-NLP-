...
def text_preprocessing(df):
    ...
    image = Image.open("C:/Resume Classification Project/pie chart.png")

    st.image(image, caption='pie chart of dataset')

    image = Image.open("C:/Resume Classification Project/Wordcloud.png")
...
try:
  ...
  resume_data=pd.read_csv("C:/Resume Classification Project/final_cleaned_data.csv")
